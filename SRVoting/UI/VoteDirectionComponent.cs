...
namespace SRVoting.UI
{
    public class VoteDirectionComponent
    {
        ...
        //private UnityAction<object, Il2CppVRTK.InteractableObjectEventArgs> onArrowUse;
        ...
        public void UpdateUI(bool isActive, bool isMyVote, string text)
        {
            ...
            if (isActive)
            {
                ...
                arrow.GetComponent<Il2CppSynth.Utils.VRTKButtonHelper>().SetActive();
            }
            else
            {
/*                arrowEvents.OnUse.RemoveAllListeners();*/

                arrow.GetComponent<Il2CppSynth.Utils.VRTKButtonHelper>().SetInactive();
            }
        }
